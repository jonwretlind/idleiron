...
export const SAVE_CONTACT_DETAILS_REQUEST = 'app/InviteNewMembersPage/SAVE_CONTACT_DETAILS_REQUEST';
export const SAVE_CONTACT_DETAILS_SUCCESS = 'app/InviteNewMembersPage/SAVE_CONTACT_DETAILS_SUCCESS';
export const SAVE_EMAIL_ERROR = 'app/InviteNewMembersPage/SAVE_EMAIL_ERROR';
export const SAVE_PHONE_NUMBER_ERROR = 'app/InviteNewMembersPage/SAVE_PHONE_NUMBER_ERROR';

export const SAVE_CONTACT_DETAILS_CLEAR = 'app/InviteNewMembersPage/SAVE_CONTACT_DETAILS_CLEAR';
